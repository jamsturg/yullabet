...
# Add the parent directory to the path so we can import the tab_api_mcp_betting module
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Import the tab_api_mcp_betting module
import tab_api_mcp_betting
...
class TestTabApiMcpBetting(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        ...
        tab_api_mcp_betting.access_token_cache = {
            "token": None,
            "expires_at": 0
        }

        # Explicitly set module globals for tests
        tab_api_mcp_betting.CLIENT_ID = "test_client_id"
        tab_api_mcp_betting.CLIENT_SECRET = "test_client_secret"
        tab_api_mcp_betting.DEFAULT_JURISDICTION = "NSW"

    def tearDown(self):
        """Clean up the test environment."""
        self.env_patcher.stop()
        # Reset module globals to avoid side effects between tests
        tab_api_mcp_betting.CLIENT_ID = ""
        tab_api_mcp_betting.CLIENT_SECRET = ""
        tab_api_mcp_betting.DEFAULT_JURISDICTION = "NSW"

    # Account Management Tests

    @patch('tab_api_mcp_betting.make_tab_api_request', new_callable=AsyncMock)
    async def test_get_account_details(self, mock_request):
        ...
        result = await tab_api_mcp_betting.get_account_details()
    ...
    async def test_get_account_balance(self, mock_request):
        ...
        result = await tab_api_mcp_betting.get_account_balance()
    ...
    async def test_get_transaction_history(self, mock_request):
        ...
        result = await tab_api_mcp_betting.get_transaction_history()
        ...
        result = await tab_api_mcp_betting.get_transaction_history('2023-01-01', '2023-01-31', 'DEPOSIT')
        self.assertEqual(result, json.dumps({'transactions': [{'id': '1', 'amount': 50.0, 'type': 'DEPOSIT'}]}, indent=2))
    ...
    async def test_place_bet(self, mock_request):
        ...
        result = await tab_api_mcp_betting.place_bet('WIN', selections, 10.0)
    ...
    async def test_get_bet_history(self, mock_request):
        ...
        # Test with no parameters
        result = await tab_api_mcp_betting.get_bet_history()
        ...
        # Test with parameters
        mock_request.reset_mock()
        result = await tab_api_mcp_betting.get_bet_history('2023-01-01', '2023-01-31', 'SETTLED')
        self.assertEqual(result, json.dumps({'bets': [{'id': '1', 'status': 'SETTLED'}]}, indent=2))
    ...
    async def test_get_active_bets(self, mock_request):
        ...
        result = await tab_api_mcp_betting.get_active_bets()
    ...
    async def test_cancel_bet(self, mock_request):
        ...
        result = await tab_api_mcp_betting.cancel_bet('12345')
    ...
    async def test_get_markets(self, mock_request):
        ...
        result = await tab_api_mcp_betting.get_markets('event1')
    ...
    async def test_get_odds(self, mock_request):
        ...
        result = await tab_api_mcp_betting.get_odds('market1')
    ...
    async def test_get_live_odds(self, mock_request):
        ...
        result = await tab_api_mcp_betting.get_live_odds('event1')
    ...
    async def test_get_event_details(self, mock_request):
        ...
        result = await tab_api_mcp_betting.get_event_details('event1')
    ...
    async def test_get_race_details(self, mock_request):
        ...
        result = await tab_api_mcp_betting.get_race_details('race1')
    ...
    async def test_get_runner_details(self, mock_request):
        ...
        result = await tab_api_mcp_betting.get_runner_details('race1', 'runner1')
    ...
    async def test_get_sport_events(self, mock_request):
        ...
        result = await tab_api_mcp_betting.get_sport_events('Rugby League')
        ...
        mock_request.reset_mock()
        result = await tab_api_mcp_betting.get_sport_events('Rugby League', 'comp1')
        self.assertEqual(result, json.dumps({'events': [{'id': 'event1', 'name': 'Test Event'}]}, indent=2))
